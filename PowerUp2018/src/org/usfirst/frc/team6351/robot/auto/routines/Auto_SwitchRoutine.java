...
public class Auto_SwitchRoutine extends CommandGroup {
    ...
    public Auto_SwitchRoutine() {
        ...
        // arm.
    	DriverStation.reportError("FIRST CHAR DATA: "+Robot.fms_gameData.substring(0,1), false);
...
//    		
//    		//ADD VISION
//    		addSequential(new Auto_ArmToPosition(1750));
...
//    	}
		...
		//ADD VISION
		addSequential(new Auto_ArmToPosition(1800));
		addSequential(new Auto_DriveStraight(60));
		addSequential(new GrabberSolenoids());
